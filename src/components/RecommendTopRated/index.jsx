...
const RecommendTopRated = () => {
  ...
  const getTopRatedTeachers = async () => {
    ...
    const res = await axios.get(
      'https://educonnectbackend-production.up.railway.app/api/ratings/top-rated',
      headers,
    );
    if (res) {
            ...
            <TouchableOpacity style={[styles.container, styles.boxShadow]}>
              ...
              <View style={[styles.bio, {width: '100%'}]}>
                ...
                <Text style={styles.bottomGap}>
                  {item.bio ? item.bio : 'Bio Not available'}
                </Text>
                <Text style={styles.bottomGap}>
                ...
                <Text style={styles.bottomGap}>
                  {item.hourlyRate ? item.hourlyRate : 'Rate Not available'}
                </Text>
                <Text style={styles.bottomGap}>
