...
export default function SelectedCourse({route}) {
  ...
  const getStudentJobBids = async () => {
    ...
    if (jobData && jobData._id) {
      ...
      const res = await axios.get(
        `https://educonnectbackend-production.up.railway.app/api/bids/${jobData._id}`,
        headers,
      );
      if (res) {
    ...
    if (jobData && jobData._id) {
      ...
      Alert.alert(
        ...
        jobData.jobPayDuration == 'oneTime'
          ? `Are you sure you want to mark this job as completed and pay fees?`
          : `Do you want to pay the ${jobData.jobPayDuration} Fees?`,
        [
          {
            text: 'Yes',
            onPress: async () => {
              ...
              if (jobData.jobPayDuration == 'oneTime') {
                ...
                res = await axios.patch(
                  `https://educonnectbackend-production.up.railway.app/api/jobs/${jobData._id}`,
                  data,
                  headers,
                );
              } else {
              ...
              if (res) {
                ...
                const res2 = await axios.post(
                  `https://educonnectbackend-production.up.railway.app/api/ratings/`,
                  review,
                  headers,
                );
                if (res2) {
                ...
                if (jobData.jobPayDuration == 'oneTime') {
                  Alert.alert(
                    'Success',
                    `Job marked completed and fees paid successfully`,
                    [
                      {
                        text: 'Cancel',
                  ...
                  Alert.alert(
                    'Success',
                    `${jobData.jobPayDuration} fees paid successfully`,
                    [
                      {
                        text: 'Cancel',
                        onPress: () => console.log('Cancel Pressed'),
  ...
  const isJobPayDate = () => {
    ...
    const monthEndPayDate = new Date(
      jobStartDate.getFullYear(),
      jobStartDate.getMonth() + 1,
      0,
    );
          ...
          {jobData.status && jobData.status == 'pending' ? (
                  ...
                  <View
                    ...
                    <Text
                      style={[
                        styles.mt10,
                        styles.mb10,
                        {fontSize: normalize(16), fontWeight: 'bold'},
                      ]}>
                      Title:
                    </Text>
                    ...
                    <View style={[styles.mt10, {flex: 1, marginLeft: 10}]}>
                      <Text
                        style={{fontSize: normalize(16), textAlign: 'right'}}>
                        {jobData.description}
                      </Text>
                    </View>
                    {/* </Text> */}
                  ...
                  <>
                    <View
                      ...
                      <Text
                        style={[
                          styles.mb10,
                          {fontSize: normalize(14), marginTop: 5},
                        ]}>
                        No bids available.
                      </Text>
                    </View>
            ...
            <View style={[{width: '100%'}, styles.boxShadow, styles.tutors]}>
              ...
              <View style={[styles.mb20, styles.mainHeading, {width: '100%'}]}>
                ...
                <Text
                  style={[styles.mt10, styles.mb10, {fontSize: normalize(16)}]}>
            ...
            <View style={[{flex: 1, justifyContent: 'center'}]}>
              <View style={[styles.modalView]}>
                ...
                <Text
                  ...
                  Please review Teacher to complete this job
                </Text>
                ...
                <View style={{width: '100%'}}>
                  {studentReviewsTeacherTouched &&
                    (!studentReviewsTeacher ||
                      studentReviewsTeacher.length == 0) && (
                      <Text style={[styles.error, {textAlign: 'center'}]}>
